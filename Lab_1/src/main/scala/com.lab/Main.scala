...
object lab1 {
  def main(args: Array[String]): Unit = {
    ...
    val csv_file_path_trips = "/Users/dabisov/data/trips.csv"
    ...
    val csv_file_path_stations = "/Users/dabisov/data/stations.csv"
...
// Task 5
  ...
  def calcDist(lat1: Double, long1: Double, lat2: Double, long2: Double): Double = {
    ...
    val a = Math.sin(latDistance / 2) * Math.sin(latDistance / 2) + Math.cos(Math.toRadians(lat1)) *
